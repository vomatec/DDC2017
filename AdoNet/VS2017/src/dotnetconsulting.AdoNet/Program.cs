...
namespace dotnetconsulting.AdoNet
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            DemoDataTable();
            DemoListAdoNetProvider();
            DemoSqlDependency();
            DemoResultSetSchema();

            DemoSqlConnectionStringBuilder();
            DemoExecuteNonQuery();
            DemoExecuteScalar();
            DemoExecuteReader();
            DemoExecuteReaderBatch();
            DemoExecuteXmlReader();

            DemoScalarParameters(DateTime.Parse("1/1/2017"));

            DemoPreparedScalarParameters(true);
            DemoTableValuedParameters(false);
            DemoTableValuedParametersAdHoc(false);
            DemoBulkCopy();
        ...
        public static void DemoListAdoNetProvider()
        {
        ...
        public static void DemoSqlDependency()
        {
        ...
        public static void DemoResultSetSchema()
        {
        ...
        public static void DemoSqlConnectionStringBuilder()
        {
        ...
        #region Execute
        public static void DemoExecuteNonQuery()
        {
            Console.WriteLine("==  DemoExecuteNonQuery() ==");
        ...
        public static void DemoExecuteScalar()
        {
            Console.WriteLine("==  DemoExecuteScalar() ==");
        ...
        public static void DemoExecuteReader()
        {
            Console.WriteLine("==  DemoExecuteReader() ==");
        ...
        public static void DemoExecuteReaderBatch()
        {
            Console.WriteLine("==  DemoExecuteReaderBatch() ==");
        ...
        public static void DemoExecuteXmlReader()
        {
            Console.WriteLine("==  DemoExecuteXmlReader() ==");
        ...
        public static void DemoScalarParameters(DateTime? CreateDate)
        {
            Console.WriteLine("==  DemoScalarParameters() ==");
        ...
        public static void DemoPreparedScalarParameters(bool UsePrepareCommand)
        {
            Console.WriteLine("==  DemoPreparedScalarParameters() ==");
        ...
        public static void DemoTableValuedParameters(bool dumpIDs)
        {
            Console.WriteLine("==  DemoTableValuedParameters() ==");
        ...
        public static void DemoTableValuedParametersAdHoc(bool dumpIDs)
        {
            Console.WriteLine("==  DemoTableValuedParametersAdhoc() ==");
            ...
            using (SqlConnection con = new SqlConnection(AdoNetTestDbConnectionString))
            {
                ...
                {
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandText = "	INSERT [dbo].[Names] SELECT * FROM @list; ";
        ...
        public static void DemoBulkCopy()
        {
            Console.WriteLine("==  DemoBulkCopy() ==");
        ...
        {
            Console.WriteLine("==  DemoTransactions() ==");
        ...
        {
            Console.WriteLine("==  DemoErrorHandling() ==");
