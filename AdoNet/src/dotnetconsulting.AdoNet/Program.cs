...
namespace dotnetconsulting.AdoNet
{
    public class Program
    {
        ...
        public static string SqlLite
        {
            get
            {
                return config["ConnectionStrings:SqlLite"];
            }
        }
        #endregion
        ...
        public static void TestSQLite()
        {
            ...
            SqliteConnectionStringBuilder scsb = new SqliteConnectionStringBuilder(SqlLite);
            ...
            if (!File.Exists(scsb.DataSource))
            {
                ...
                // Verbindung aufbauen
                using (SqliteConnection con = new SqliteConnection(SqlLite))
                {
                    con.Open();
